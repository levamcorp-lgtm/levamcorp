...
<title>Application Approved — Levam Corp Distributors</title>
<style>
...
<span style="display: none !important; visibility: hidden; opacity: 0; height: 0; width: 0; overflow: hidden; mso-hide: all; font-size: 1px; line-height: 1px; color: #0a0b0d;">Approved — your partner account is open. Live wholesale pricing and stock are waiting in the portal.</span>
...
<td style="background-color: #f2efe6; padding: 0;">
    ...
    <td class="lvm-pad" style="padding: 11px 28px 12px 28px; border-bottom: 1px solid rgba(8,9,11,0.18);">
      ...
      <tr>
        ...
        <td width="40%" class="lvm-right" style="width: 40%; text-align: right; font-family: 'Courier New', Courier, monospace; font-size: 10px; letter-spacing: 2px; color: #5c5a55; text-transform: uppercase; mso-line-height-rule: exactly; line-height: 15px;">
          <span style="color: #2F7DF6;">&#9632;</span>&nbsp; STATUS &middot; APPROVED
        </td>
      </tr>
      </table>
    </td>
    ...
    <td class="lvm-pad" style="padding: 26px 28px 0 28px;">
      ...
      <tr>
        <td style="border: 2px solid #2F7DF6; padding: 8px 14px 9px 14px; text-align: center;">
          <div style="font-family: 'Courier New', Courier, monospace; font-size: 13px; font-weight: bold; letter-spacing: 4px; color: #2F7DF6; text-transform: uppercase; mso-line-height-rule: exactly; line-height: 16px;">Approved</div>
  ...
  <tr>
    <td class="lvm-pad" style="padding: 22px 28px 8px 28px;">
      <div style="font-family: 'Courier New', Courier, monospace; font-size: 10px; letter-spacing: 2px; color: #6d6a64; text-transform: uppercase; mso-line-height-rule: exactly; line-height: 14px; padding-bottom: 14px;">Reviewed &amp; cleared</div>
      <h1 class="lvm-h1" style="margin: 0; font-family: Helvetica, Arial, sans-serif; font-size: 34px; font-weight: normal; letter-spacing: -1.2px; color: #08090b; mso-line-height-rule: exactly; line-height: 37px;">You're approved<span style="color: #2F7DF6;">.</span> Welcome aboard.</h1>
    </td>
  </tr>
  <tr>
    <td class="lvm-pad" style="padding: 18px 28px 6px 28px; font-family: Helvetica, Arial, sans-serif; font-size: 15px; color: #3f3d39; mso-line-height-rule: exactly; line-height: 25px;">
      Hi <strong style="color: #08090b;">${displayName}</strong> — your application for <strong style="color: #08090b;">${businessName}</strong> has been approved. Your partner account is now active.
    </td>
  </tr>
  <tr>
    ...
    <td class="lvm-pad" style="padding: 22px 28px 22px 28px;">
      ...
      <tr>
        <td width="50%" class="lvm-stack" style="width: 50%; vertical-align: bottom;">
          ...
          <div style="padding-top: 8px; font-family: 'Courier New', Courier, monospace; font-size: 10px; letter-spacing: 2px; color: #08090b; text-transform: uppercase; mso-line-height-rule: exactly; line-height: 14px;">Dispatch from Doral</div>
        </td>
        <td width="50%" class="lvm-stack" style="width: 50%; vertical-align: bottom; padding-top: 0;">
          ...
          <div style="padding-top: 8px; font-family: 'Courier New', Courier, monospace; font-size: 10px; letter-spacing: 2px; color: #08090b; text-transform: uppercase; mso-line-height-rule: exactly; line-height: 14px;">Unlocked for you</div>
        </td>
      </tr>
      </table>
    </td>
...
<td style="background-color: #f2efe6; padding: 0;">
  ...
  <tr>
    <td class="lvm-pad" style="padding: 0 28px;">
      ...
      <tr>
        <td width="40%" style="width: 40%; padding: 13px 0 14px 0; border-bottom: 1px solid rgba(8,9,11,0.14); font-family: 'Courier New', Courier, monospace; font-size: 10px; letter-spacing: 2px; color: #6d6a64; text-transform: uppercase; mso-line-height-rule: exactly; line-height: 15px;">Approved</td>
    ...
    <td class="lvm-pad" style="padding: 0 28px;">
      ...
      <tr>
        ...
        <td style="padding: 14px 0 16px 0; border-top: 1px solid rgba(8,9,11,0.12); vertical-align: top;">
          <div style="font-family: Helvetica, Arial, sans-serif; font-size: 16px; color: #08090b; mso-line-height-rule: exactly; line-height: 21px;">Build your first order</div>
          <div style="padding-top: 5px; font-family: Helvetica, Arial, sans-serif; font-size: 14px; color: #6d6a64; mso-line-height-rule: exactly; line-height: 21px;">MOQ is shown next to every SKU. Ask us for a quote on volume.</div>
        </td>
      </tr>
      <tr>
        ...
        <td style="padding: 14px 0 16px 0; border-top: 1px solid rgba(8,9,11,0.12); border-bottom: 1px solid rgba(8,9,11,0.2); vertical-align: top;">
          <div style="font-family: Helvetica, Arial, sans-serif; font-size: 16px; color: #08090b; mso-line-height-rule: exactly; line-height: 21px;">Meet your rep</div>
          <div style="padding-top: 5px; font-family: Helvetica, Arial, sans-serif; font-size: 14px; color: #6d6a64; mso-line-height-rule: exactly; line-height: 21px;">The same named contact every time — in English or Spanish.</div>
        </td>
      </tr>
      </table>
    </td>
    ...
    <td class="lvm-pad" style="padding: 10px 28px 26px 28px;">
      ...
      <tr>
        <td style="border: 1px solid #08090b; padding: 14px 20px; text-align: center;">
          <a href="https://wa.me/17864909005" style="display: block; font-family: 'Courier New', Courier, monospace; font-size: 11px; letter-spacing: 2px; color: #08090b; text-transform: uppercase; text-decoration: none; mso-line-height-rule: exactly; line-height: 16px;">Talk to your rep on WhatsApp</a>
        </td>
      </tr>
      </table>
    </td>
...
<td style="background-color: #101114; padding: 0;">
  ...
  <tr>
    <td class="lvm-pad" style="padding: 20px 28px 24px 28px; font-family: 'Courier New', Courier, monospace; font-size: 9px; letter-spacing: 2px; color: #5f5d58; text-transform: uppercase; mso-line-height-rule: exactly; line-height: 16px;">
      You received this because your partner account was approved<br />
      &copy; ${new Date().getFullYear()} Levam Corp Distributors &middot; Doc 02 &middot; Rev. 08
    </td>
  </tr>
  </table>
</td>
