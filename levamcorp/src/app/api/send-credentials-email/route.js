    ...
    <td class="lvm-pad" style="padding: 26px 28px 8px 28px;">
      ...
      <tr>
        <td bgcolor="#08090b" style="background-color: #08090b; padding: 15px 20px; text-align: center;">
          <a href="https://levamcorp.com/portal" style="display: block; font-family: 'Courier New', Courier, monospace; font-size: 11px; font-weight: bold; letter-spacing: 2px; color: #f2efe6; text-transform: uppercase; text-decoration: none; mso-line-height-rule: exactly; line-height: 16px;">Access your portal &nbsp;&rarr;</a>
        </td>
      </tr>
      </table>
    </td>
