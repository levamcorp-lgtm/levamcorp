  ...
  return (
    <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', minHeight: '100vh' }}>
      ...
      <div style={{ background: '#0d0d0d', padding: '3rem 3.5rem', display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
        ...
        {/* CENTER CONTENT */}
        <div>
          <div style={{ fontSize: 10, letterSpacing: '0.3em', textTransform: 'uppercase', color: '#2d7dd2', marginBottom: '1rem', fontWeight: 600 }}>Partner portal</div>
          <h2 style={{ fontSize: 40, fontWeight: 800, color: '#fff', lineHeight: 1.1, marginBottom: '1.25rem', letterSpacing: '-0.02em' }}>Your private distribution hub</h2>
          <p style={{ fontSize: 15, color: 'rgba(255,255,255,0.4)', lineHeight: 1.8, marginBottom: '2.5rem', maxWidth: 340 }}>
            Access your full catalog, submit orders, generate quotes and invoices — all in one place.
          </p>
          <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
            {[
              [<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#2d7dd2" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/></svg>, 'Full product catalog with live pricing'],
              [<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#2d7dd2" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="1" y="4" width="22" height="16" rx="2"/><line x1="1" y1="10" x2="23" y2="10"/></svg>, 'Automatic quote & invoice generation'],
              [<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#2d7dd2" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/></svg>, 'Real-time availability & dispatch times'],
              [<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#2d7dd2" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z"/><circle cx="12" cy="10" r="3"/></svg>, 'Full order history & tracking'],
            ].map(([icon, label]) => (
              <div key={label} style={{ display: 'flex', alignItems: 'center', gap: 14, fontSize: 14, fontWeight: 500, color: 'rgba(255,255,255,0.6)' }}>
                {icon} {label}
              </div>
            ))}
          </div>
      ...
      <div style={{ background: '#fff', padding: '3rem 2.5rem', display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
        <div style={{ maxWidth: 380, width: '100%', margin: '0 auto' }}>
          <div style={{ marginBottom: '2.5rem' }}>
            ...
            <h3 style={{ fontSize: 30, fontWeight: 800, color: '#111', marginBottom: '0.5rem', letterSpacing: '-0.02em' }}>Sign in to your account</h3>
          ...
          <div style={{ marginBottom: '1rem' }}>
            <label style={{ fontSize: 11, fontWeight: 700, color: '#444', display: 'block', marginBottom: 6, letterSpacing: '0.06em', textTransform: 'uppercase' }}>Email address</label>
          ...
          <button onClick={handleLogin} disabled={loading} style={{ width: '100%', padding: 15, background: loading ? '#aaa' : '#2d7dd2', color: '#fff', fontSize: 13, fontWeight: 700, letterSpacing: '0.1em', textTransform: 'uppercase', border: 'none', cursor: loading ? 'not-allowed' : 'pointer', borderRadius: 3, marginBottom: '1.25rem', boxShadow: '0 4px 16px rgba(45,125,210,0.35)' }}>
