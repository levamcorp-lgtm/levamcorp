      ...
      <div style={{ padding: '0.875rem' }}>
        ...
        <div style={{ display: 'flex', gap: 6 }}>
          <div style={{ display: 'flex', alignItems: 'center', border: '1px solid rgba(0,0,0,0.1)', borderRadius: 3, overflow: 'hidden', opacity: outOfStock ? 0.4 : 1 }}>
            ...
            <input type="number" value={qty} disabled={outOfStock} onChange={e => setQty(Math.min(maxQty, Math.max(product.moq || 1, parseInt(e.target.value)||(product.moq||1))))} style={{ width: 36, textAlign: 'center', fontSize: 12, fontWeight: 600, border: 'none', outline: 'none', background: '#fff', color: '#333', fontFamily: 'inherit' }} />
